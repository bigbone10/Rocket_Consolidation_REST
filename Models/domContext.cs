...
{
    public partial class domContext : DbContext
    {
        public domContext()
        {
        }

        public domContext(DbContextOptions<domContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=codeboxx.cq6zrczewpu2.us-east-1.rds.amazonaws.com;port=3306;database=dom;user=codeboxx;password=Codeboxx1!");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Interventions>(entity =>
            {
                ...
                entity.Property(e => e.InterventionReport)
                    .HasColumnName("intervention_report")
                    .HasColumnType("text");

                entity.Property(e => e.InterventionResult)
                    .HasColumnName("intervention_result")
                    .HasColumnType("varchar(255)");
                ...
                entity.Property(e => e.InterventionStatus)
                    .HasColumnName("intervention_status")
                    .HasColumnType("varchar(255)");
            });
